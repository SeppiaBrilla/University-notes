The PCA is an algorthm that's provide an easy way to shrink the number of dimensions (and data as a concequence) needed to represent some data with the minimum loss.
