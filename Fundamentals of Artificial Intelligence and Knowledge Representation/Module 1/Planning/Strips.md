Strips (Stanford research institute problem solver) is a [[Planning]] algorithm / language. it is a type of [[Linear planning]] that uses both forward and backward strategies to compute the [[Search strategies]].
