Many artificial intelligence problems can be seen as constraint satisfaction problems: we can model our problem as finding a state that meets a given set of constraints.
