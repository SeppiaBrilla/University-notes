...
Ideally, we would like to inspect a clause only when all but one literals have been assigned. In a real world scenario, this is impossible, but we can use an approximate approach:
