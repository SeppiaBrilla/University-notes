As for [[Combinatorial Decision Making and Optimization/Constraint satisfaction problem|CSP]], with [[Satisfiability Modulo Theory (SMT)]] we can [[Theory solvers|solve them]] or even optimize their solution.
