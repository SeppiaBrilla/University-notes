Note: this is an extension on the [[Constraint satisfaction problem]] notes taken for module one of FAIKR course. It is more in depth but cover more or less the same things.  
